...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SaldoWms.precio'
        db.add_column('aluminio_saldowms', 'precio', orm['aluminio.saldowms:precio'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SaldoWms.precio'
        db.delete_column('aluminio_saldowms', 'precio')
