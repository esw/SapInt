...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UbicacionSap.area'
        db.add_column('aluminio_ubicacionsap', 'area', orm['aluminio.ubicacionsap:area'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'UbicacionSap.area'
        db.delete_column('aluminio_ubicacionsap', 'area')
