...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SaldoWms.sapalum'
        db.add_column('aluminio_saldowms', 'sapalum', orm['aluminio.saldowms:sapalum'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SaldoWms.sapalum'
        db.delete_column('aluminio_saldowms', 'sapalum_id')
