...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aleacion.especial'
        db.add_column('aluminio_aleacion', 'especial', orm['aluminio.aleacion:especial'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Aleacion.especial'
        db.delete_column('aluminio_aleacion', 'especial')
