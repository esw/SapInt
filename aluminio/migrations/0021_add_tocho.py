...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tocho'
        db.create_table('aluminio_tocho', (
            ('cod_sap', orm['aluminio.tocho:cod_sap']),
            ('aleacion', orm['aluminio.tocho:aleacion']),
            ('id', orm['aluminio.tocho:id']),
            ('tipo', orm['aluminio.tocho:tipo']),
        ))
        db.send_create_signal('aluminio', ['Tocho'])
        
        # Creating unique_together for [cod_sap] on Tocho.
        db.create_unique('aluminio_tocho', ['cod_sap'])
        
        # Creating unique_together for [tipo, aleacion] on Tocho.
        db.create_unique('aluminio_tocho', ['tipo', 'aleacion_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'Tocho'
        db.delete_table('aluminio_tocho')
        
        # Deleting unique_together for [cod_sap] on Tocho.
        db.delete_unique('aluminio_tocho', ['cod_sap'])
        
        # Deleting unique_together for [tipo, aleacion] on Tocho.
        db.delete_unique('aluminio_tocho', ['tipo', 'aleacion_id'])
    ...
    models = {
        ...
        'aluminio.aleacion': {
            ...
            'especial': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'aluminio.tocho': {
            'Meta': {'unique_together': "(('tipo', 'aleacion'), ('cod_sap',))"},
            'aleacion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aluminio.Aleacion']"}),
            'cod_sap': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'aluminio.sapaluminio': {
            'Meta': {'unique_together': "(('referencia', 'aleacion', 'temple', 'acabado', 'largo_mm', 'tipo_mat'), ('cod_sap',))"},
            'acabado': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aluminio.Acabado']"}),
            'aleacion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aluminio.Aleacion']"}),
        ...
        'aluminio.tipoacabado': {
            ...
            'd_clear': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'texto_lista': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'})
        },
