...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Acabado.prod_alutions'
        db.add_column('aluminio_acabado', 'prod_alutions', orm['aluminio.acabado:prod_alutions'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Acabado.prod_alutions'
        db.delete_column('aluminio_acabado', 'prod_alutions')
