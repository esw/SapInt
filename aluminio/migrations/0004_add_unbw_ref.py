...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referencia.unbw'
        db.add_column('aluminio_referencia', 'unbw', orm['aluminio.referencia:unbw'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Referencia.unbw'
        db.delete_column('aluminio_referencia', 'unbw')
