...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipoAcabado.d_clear'
        db.add_column('aluminio_tipoacabado', 'd_clear', orm['aluminio.tipoacabado:d_clear'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'TipoAcabado.d_clear'
        db.delete_column('aluminio_tipoacabado', 'd_clear')
