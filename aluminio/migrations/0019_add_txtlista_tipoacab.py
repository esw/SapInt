...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipoAcabado.texto_lista'
        db.add_column('aluminio_tipoacabado', 'texto_lista', orm['aluminio.tipoacabado:texto_lista'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'TipoAcabado.texto_lista'
        db.delete_column('aluminio_tipoacabado', 'texto_lista')
