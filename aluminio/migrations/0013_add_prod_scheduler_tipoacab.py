...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TipoAcabado.prod_scheduler'
        db.add_column('aluminio_tipoacabado', 'prod_scheduler', orm['aluminio.tipoacabado:prod_scheduler'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'TipoAcabado.prod_scheduler'
        db.delete_column('aluminio_tipoacabado', 'prod_scheduler')
    ...
    models = {
        ...
        'aluminio.saldowms': {
            ...
            'sapalum': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aluminio.SapAluminio']", 'null': 'True'}),
