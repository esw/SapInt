...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SaldoWms.precio'
        # (to signature: django.db.models.fields.IntegerField(null=True, blank=True))
        db.alter_column('aluminio_saldowms', 'precio', orm['aluminio.saldowms:precio'])
        
        # Changing field 'SaldoWms.grupo_val'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['aluminio.GrupoValoracion'], null=True, blank=True))
        db.alter_column('aluminio_saldowms', 'grupo_val_id', orm['aluminio.saldowms:grupo_val'])
        
        # Changing field 'SaldoWms.sapalum'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['aluminio.SapAluminio'], null=True, blank=True))
        db.alter_column('aluminio_saldowms', 'sapalum_id', orm['aluminio.saldowms:sapalum'])
        
        # Changing field 'Acabado.grupo_val'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['aluminio.GrupoValoracion'], null=True, blank=True))
        db.alter_column('aluminio_acabado', 'grupo_val_id', orm['aluminio.acabado:grupo_val'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SaldoWms.grupo_val'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['aluminio.GrupoValoracion'], null=True))
        db.alter_column('aluminio_saldowms', 'grupo_val_id', orm['aluminio.saldowms:grupo_val'])
        
        # Changing field 'SaldoWms.sapalum'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['aluminio.SapAluminio'], null=True))
        db.alter_column('aluminio_saldowms', 'sapalum_id', orm['aluminio.saldowms:sapalum'])
